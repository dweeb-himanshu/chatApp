...
//init applozic plugin for 
  ...
  //       if(localStorage.getItem("groupData") !== null && localStorage.getItem("groupData") !== undefined){
  //         $rootScope.groupContacts = JSON.parse(localStorage.getItem("groupData"));
  //         console.log("getting from local..."+$rootScope.groupContacts);
  //       }
  ...
  //       }
  //       else{
  //         for(var i in $rootScope.groupContacts.blocks){
  //           $scope.groupsUserMemberOf[i] = $rootScope.groupContacts.blocks[i].block_id;
  //           console.log($scope.groupsUserMemberOf[i]);
  //         };
  //       }
  //       // Subscribing the messages from meteor
  //       subscribeMessages();
        
  //     };
  //     // Every time this page will load, getGroupsUserMemberOf will be called
  //     // and this function calls the subscribeMessages which loads the messages from db.

  //     if($rootScope.apiCallFlag === true || $rootScope.apiCallFlag === null || $rootScope.apiCallFlag === undefined){
  //       getGroupsUserMemberOf();
  //     }
